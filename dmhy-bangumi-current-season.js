...
(function () {
    ...
    let DataURL = localStorage.DataURL || 'https://cdn.jsdelivr.net/gh/Theergold/dmhy-bangumi-current-season@master/bangumi-data.js';
    ...
    loadJS('https://cdn.jsdelivr.net/gh/Theergold/dmhy-bangumi-current-season@master/history-list.js', function () {
